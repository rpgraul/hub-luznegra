...
export default function AvatarDropdown() {
  ...
  function openProfile() {
    window.dispatchEvent(new CustomEvent('hub:open-profile-drawer'))
  }
    ...
    <Dropdown.Root>
      ...
      <Dropdown.Popover>
        <Dropdown.Menu>
          ...
          <Dropdown.Item key="perfil" onAction={openProfile}>
            <i className="fa-solid fa-user mr-2" />
            Perfil
          </Dropdown.Item>
          {!onFerias && (
            <Dropdown.Item key="ferias" onAction={openProfile}>
